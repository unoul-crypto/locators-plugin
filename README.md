...
Готовый файл: `target/Locators-1.2.0.jar`. Поместите его в `plugins` сервера и перезапустите сервер.
...
вертикальный; при необходимости можно последовательно нажать оба значения. Ссылки одноразовые,
привязаны к получившему результат игроку и действуют 120 секунд.
